                        ...
                        j = function () {
                            if (c.settings.pollChanges) {
                                var a = d.scrollWidth,
                                    ...
                                    m = e.height(),
                                    n = e.offset();
                                (c.settings.verticalScrolling && (m !== g || k !== i) || c.settings.horizontalScrolling && (l !== f || a !== h)) && (h = a, i = k, B.resize.call(e)), (b.left !== n.left || b.top !== n.top || l !== f || m !== g) && (b = n, f = l, g = m, B.reposition.call(e)), setTimeout(j, 10)
                            }
                        };
        ...
        return B[d] ? B[d].call(this) : (f = a.extend({}, e, d), this.each(function () {
            if (f.verticalScrolling || f.horizontalScrolling) {
                ...
                L.on({
                    ...
                    _endX: 0,
                    _endY: 0,
                    _duration: 2,//parseInt(f.easingDuration / 16.66666, 10),
